...
class ReservationRepository(ABC):
    ...
    @abstractmethod
    async def update(self, reservation_id: int, host_token_hash: str, now: datetime, *, start_at: datetime | None = None, duration_minutes: int | None = None, ranks: list[str] | None = None, match_type: MatchType | None = None, capacity: int | None = None, memo: str | None = None) -> Reservation: ...
